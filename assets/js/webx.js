...
(function () {
  ...
  function initMobileNav() {
    ...
    foot.href = 'mailto:hello@thewebxstudio.com';
    foot.textContent = 'hello@thewebxstudio.com';
  ...
  function initPageTransition() {
    ...
    if (reduce) {
      ...
      // Hindi (India) · Arabic (Gulf) · Spanish · French · English (UK/US).
      // Non-Latin scripts fall back to the system font - no extra web-font load.
      var greetings = ['नमस्ते', 'مرحبا', 'Hola', 'Bonjour', 'Hello'];
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (endpoint) {
        ...
        fetch(endpoint, { method: 'POST', headers: { Accept: 'application/json' }, body: new FormData(form) })
          ...
          .catch(function () { if (btn) { btn.disabled = false; if (btn.dataset.label) btn.innerHTML = btn.dataset.label; } window.alert('Sorry - something went wrong. Please email hello@thewebxstudio.com'); });
      } else { done(); }
    });
  }
